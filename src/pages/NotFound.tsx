...
const NotFound = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col space-y-10 items-center relative z-10 text-white text-center">
        {/* <Frown className="w-24 h-24 text-primary mb-4" /> */}
        <h1 className="text-[8rem] mb-20 md:text-[10rem] font-bold text-white drop-shadow-[0_2px_6px_rgba(0,0,0,1)]">
          404
        </h1>
        <p className="text-[1rem] font-medium mb-10 md:text-[1.5rem] text-white drop-shadow-[0_2px_6px_rgba(0,0,0,1)] max-w-5xl">
